...
it('shows filter bar when submissions exist', async () => {
  ...
  await waitFor(() => {
    expect(screen.getByPlaceholderText('Tất cả lớp')).toBeInTheDocument()
    expect(screen.getByPlaceholderText('Tất cả khóa học')).toBeInTheDocument()
    expect(screen.getByPlaceholderText('Tất cả bài học')).toBeInTheDocument()
