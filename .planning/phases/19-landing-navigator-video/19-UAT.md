...
number: 1
name: DB Migration — Cold Start Check
expected: |
  File supabase/migrations/20260518_27_courses_is_outstanding.sql exists with
  ALTER TABLE courses ADD COLUMN IF NOT EXISTS is_outstanding boolean NOT NULL DEFAULT false.
  (Apply in Supabase Dashboard SQL Editor before testing catalog filter.)
